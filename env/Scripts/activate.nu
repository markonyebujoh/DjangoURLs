...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\GOTNI\Documents\Python\DjangoURLs\DjangoURLs\env'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Users\GOTNI\Documents\Python\DjangoURLs\DjangoURLs\env\Scripts\deactivate.nu'
